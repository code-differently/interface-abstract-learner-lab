...
-
### Part 9.1 - Create `CodeDifferently` Class
...
-
### Part 10.3 - Refactor `CodeDifferently` class
* Refactor the `hostLecture` method in the `CodeDifferently` class by removing any intermediate _casting trick(s)_.

-
### Part 10.0 - Test refactored classes.
* Ensure that the `TestStudents`, `TestInstructors`, `TestPeople`, `TestCodeDifferently` classes were not affected by the refactor.
...
-
### Part 12.0 - Test `CodeDifferently`
